...
namespace Untitled
{
	public class MusicPlayer: Node
	{
		...
		public MusicPlayer()
		{
			...
			if (defined(Designer))
			{
				_sound = new Sound("H:\\Dropbox\\Indigo\\TG2014\\Projects\\Demo\\Untitled\\Assets\\demotg14_less A2_longer_intro_fixed_fuckups_pitchbend_are_you_satisfied_you_damn_coder.mp3");
				//_sound = new Sound("C:\\Users\\joehol\\Dropbox\\Indigo\\TG2014\\Projects\\Demo\\Untitled\\Assets\\demotg14_less A2_longer_intro_fixed_fuckups_pitchbend_are_you_satisfied_you_damn_coder.mp3");
			} else {
				_sound = new Sound(import BundleFile("Assets/demotg14_less A2_longer_intro_fixed_fuckups_pitchbend_are_you_satisfied_you_damn_coder.mp3"));
			}
